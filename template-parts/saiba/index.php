<?php
$titulo_saiba = get_field('titulo_saiba');
$subtitulo_saiba = get_field('subtitulo_saiba');
$descricao_saiba = get_field('descricao_saiba');
$tituloDoConteudo = get_field('titulo_do_conteudo_saiba');
$conteudo = get_field('conteudo_saiba');
$botao = get_field('botao_saiba');
?>
  ...
  <div class="container-fluid">
    <div class="row px-3 titlePrimeRow">
      ...
      <div class="boxTitlePrime">
        ...
        <p class="title"><?php echo $titulo_saiba; ?> <span class="barrerHorizontal"></span></p>
        <h5 class="subtitle"><?php echo $subtitulo_saiba; ?></h5>
      </div>

      <div class="boxDescriptionPrime">
        <small class="description"><?php echo $descricao_saiba; ?></small>
      </div>
